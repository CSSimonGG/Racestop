<x-app-layout>
    <x-slot:title>
        F1 Calendar | Racestop
    </x-slot:title>
    <div class="flex justify-center">
        <span class="bg-white w-[1024px]">
            <main class="flex">
                <div>
                    <h1 class="m-5 font-bold text-2xl">2023 F1 Calendar</h1>
                    <div class="w-[664px] m-5 mb-20 p-5 bg-gray">
                        <div class="w-[624px]">
                            ...
                            @foreach ($f1races as $f1race)
                                <a href="/f1/gp/{{ Str::slug($f1race->grandprix->grand_prix) }}">
                                <div
                                    class="text-sm border border-platinum bg-white w-[624px] h-[60px] py-4 grid grid-cols-12 space-x-5">
                                    <div class="col-span-3">
                                        <span class="ml-2 font-bold">
                                            <img class="h-[16px] inline" src="/images/flags/{{ $f1race->grandprix->country->flag_path }}"
                                                 alt="">
