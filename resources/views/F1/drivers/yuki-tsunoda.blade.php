                ...
                <div class="my-5 lg:ml-5">
                    <div class="lg:flex">
                        <div class="lg:mr-5 mb-5 max-3xsm:5xsm:ml-5">
                            <h1 class="mb-5 font-bold max-5xsm:ml-5 5xsm:text-2xl">Yuki Tsunoda</h1>
                            <div
                                ...
                                <div class="3xsm:w-[483px] max-3xsm:w-[90vw]">
                                    <div class="max-5xsm:h-[250px] 5xsm:h-[300px]">
                                        ...
                                        <img src="/images/teams/alphatauri.png" alt="AlphaTauri"
                                            class="max-3xsm:hidden w-[190px]  absolute top-8 right-[12px]">
