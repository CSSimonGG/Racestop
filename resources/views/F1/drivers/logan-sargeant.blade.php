                ...
                <div class="my-5 lg:ml-5">
                    <div class="lg:flex">
                        <div class="lg:mr-5 mb-5 max-3xsm:5xsm:ml-5">
                            <h1 class="mb-5 font-bold max-5xsm:ml-5 5xsm:text-2xl">Logan Sargeant</h1>
                            <div
                        ...
                        <div class="flex space-x-10 text-lg lg:mt-12 max-3xsm:ml-5">
                            ...
                            <div class="flex flex-col space-y-1">
                                ...
                                <div>0</div>
                                <div>31/12/2000</div>
                                <div>Fort Lauderdale, Florida, U.S.</div>
                            </div>
                        </div>
                    </div>
