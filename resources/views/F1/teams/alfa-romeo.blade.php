                ...
                <div class="my-5 lg:ml-5">
                    <div class="lg:flex">
                        <div class="3xsm:w-[483px] max-3xsm:w-[90vw] mb-5 lg:mr-5">
                            <h1 class="mb-5 max-3xsm:ml-5 font-bold text-2xl">Alfa Romeo</h1>
                            <div
                                ...
                                <img src="/images/drivers/valtteri-bottas.png" alt="Valtteri Bottas"
                                    class="max-4xsm:hidden w-[240px] h-[240px] absolute bottom-0 -left-[6px]">
                        ...
                        <div class="flex space-x-10 text-lg lg:mt-12 max-3xsm:ml-5">
                            ...
                            <div class="flex flex-col space-y-1">
                                <div>Alfa Romeo F1 Team Stake</div>
                                <div>Swiss</div>
                                <div>Alessandro Alunni Bravi</div>
                                <div>Ferrari</div>
                                <div>0</div>
                                <div>1007</div>
                                <div>1 (x1)</div>
                                ...
                                <div class="w-[322px] mb-5 lg:mr-5">
                                    <div class="h-[200px] w-[322px] bg-night relative">
                                        <svg width="200" height="200" viewBox="0 0 200 200" fill="none"
                                            ...
                                            <path d="M0 0H200L98 200H0V0Z" fill="#c92d4b" />
                                        </svg>

                                        <img src="/images/drivers/valtteri-bottas.png" alt="Volttari Bottas"
                                            class="w-[220px] h-[220px] absolute -top-5 -left-1">
                                        <img src="/images/teams/alfaromeo.png" alt="Alfa Romeo"
                                            class="h-[105px] absolute top-2.5 right-[8px]">
                                        <img src="/images/flags/fin-flag.png" alt="FIN"
                            ...
                            <a href="/f1/drivers/guanyu-zhou">
                                <div class="w-[322px] mb-5">
                                    <div class="h-[200px] w-[322px] bg-night relative">
                                        ...
                                        <img src="/images/teams/alfaromeo.png" alt="Alfa Romeo"
                                            class="h-[105px] absolute top-2.5 right-[8px]">
                                        <img src="/images/flags/chn-flag.png" alt="CHN"
                                            class="w-[80px] absolute right-5 bottom-5">
                                    </div>
                                    <div class="h-[50px] w-[322px] border relative">
                                        <span class="absolute left-2">
