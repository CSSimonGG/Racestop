                ...
                <div class="my-5 lg:ml-5">
                    <div class="lg:flex">
                        <div class="3xsm:w-[483px] max-3xsm:w-[90vw] mb-5 lg:mr-5">
                            <h1 class="mb-5 max-3xsm:ml-5 font-bold text-2xl">Aston Martin</h1>
                            <div
                                ...
                                <img src="/images/teams/astonmartin.png" alt="Aston Martin"
                                    class="w-[200px] mt-12 absolute top-0">
                                <img src="/images/drivers/fernando-alonso.png" alt="Fernando Alonso"
                                    class="max-4xsm:hidden w-[240px] h-[240px] absolute bottom-0 -left-[13px]">
                        ...
                        <div class="flex space-x-10 text-lg lg:mt-12 max-3xsm:ml-5">
                            ...
                            <div class="flex flex-col space-y-1">
                                <div>Aston Martin Aramco Cognizant F1 Team</div>
                                <div>British</div>
                                <div>Mike Krack</div>
                                <div>Mercedes</div>
                                <div>0</div>
