                ...
                <div class="my-5 lg:ml-5">
                    <div class="lg:flex">
                        <div class="lg:mr-10 mb-5 max-3xsm:4xsm:ml-5">
                            <h1 class="mb-5 font-bold max-5xsm:ml-5 5xsm:text-2xl">Miami GP</h1>
                            <div
                                ...
                                <div class="4xsm:w-[440px] max-3xsm:w-[90vw] mx-5 flex">
                                    <div class="font-bold">
                                        <img class="w-[210px]" src="/images/circuit/miami-international-autodrome.png"
                                            alt="Miami International Autodrome">
                                        <h1 class="text-white text-2xl">Miami GP</h1>
                                        <h1 class="text-light-red text-xl">Miami International Autodrome</h1>
                                    </div>
                        ...
                        <div class="flex space-x-10 text-lg lg:mt-12 max-3xsm:ml-5">
                            ...
                            <div class="flex flex-col space-y-1">
                                <div>Miami</div>
                                <div>Miami International Autodrome</div>
                                <div>2022</div>
                                <div>57</div>
                                <div>5.412 km</div>
                                <div>308.326 km</div>
                                <div>1:29.708 &lpar;2023&rpar;</div>
