                ...
                <div class="my-5 lg:ml-5">
                    <div class="lg:flex">
                        <div class="lg:mr-10 mb-5 max-3xsm:4xsm:ml-5">
                            <h1 class="mb-5 font-bold max-5xsm:ml-5 5xsm:text-2xl">Qatar GP</h1>
                            <div
                                ...
                                <div class="4xsm:w-[440px] max-3xsm:w-[90vw] mx-5 flex">
                                    <div class="font-bold">
                                        <img class="w-[210px]" src="/images/circuit/losail-international-circuit.png"
                                            alt="Losail International Circuit">
                                        <h1 class="text-white text-2xl">Qatar GP</h1>
                                        <h1 class="text-light-red text-xl">Losail International Circuit</h1>
                                    </div>
                                    <div class="text-white mt-5 ml-5 relative">
                                        <h2 class="text-xl font-bold">2023 Grand Prix</h2>
                                        <h3>06-08 Oct</h3>
                                        <img class="absolute bottom-10 w-[80px]" src="/images/flags/qat-flag.png"
                                            alt="QAT">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="flex space-x-10 text-lg lg:mt-12 max-3xsm:ml-5">
                            ...
                            <div class="flex flex-col space-y-1">
                                <div>Qatar</div>
                                <div>Losail International Circuit</div>
                                <div>2021</div>
                                <div>57</div>
                                <div>5.418 km</div>
                                <div>308.826 km</div>
                                <div>1:23.196 &lpar;2021&rpar;</div>
