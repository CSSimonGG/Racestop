        ...
        <div class="mx-4">
            ...
            >
                ...
                <ul class="max-4xsm:mt-8">
                    ...
                    <li class="hover:text-silver">
                        <a href="mailto:info@racestop.net">info@racestop.net</a>
                    </li>
                </ul>
                <ul class="max-2xsm:mt-8">
                    <li class="text-light-red text-2xl font-bold mb-4">
                        RACESTOP
                    </li>
                    <a
            ...
            <div class="mt-8 right-0 text-white flex justify-center">
                <p>&copy; 2023 Racestop.net</p>
            </div>
        </div>
    </footer>
</template>
